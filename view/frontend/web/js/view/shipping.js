...
define([
    ...
    return Component.extend({
        defaults: {
            ...
            shippingMethodItemTemplate: 'Zenda_Shipping/shipping-address/shipping-method-item',
            zendaLogo: require.toUrl('Zenda_Shipping/images/zenda-logo.svg')
        },
        ...
        isZendaMethod: function (method) {
            return method.method_code === 'zenda';
        },

        getMethodTitle: function (method) {
            if (method.method_code !== 'zenda') {
                return method.method_title;
            }

            var title = method.method_title;
